...
"title" : "Update XBian",
"smalltitle" : "update",
"description" : 'You can now choose how XBian will be updated and how often to check for updates.[CR][CR]By default, XBian will not be updated automatically, but you will be advised when a new update is available.[CR][CR]To update go to System -> XBian -> Update and select the packages to upgrade.[CR][CR]If you wish XBian to be updated automatically, you can set it now.',
